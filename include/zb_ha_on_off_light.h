...
#define ZB_HA_DEVICE_VER_ON_OFF_LIGHT 1

#define ZB_HA_ON_OFF_LIGHT_IN_CLUSTER_NUM 5
#define ZB_HA_ON_OFF_LIGHT_OUT_CLUSTER_NUM 0

#define ZB_HA_ON_OFF_LIGHT_REPORT_ATTR_COUNT ZB_ZCL_ON_OFF_REPORT_ATTR_COUNT
